...
from classes_and_helpers.helpers import *
from classes_and_helpers.buttons_to_use import *
from images import *
from music import *
...
class Game1:
    def __init__(self):
        ...
        self.level = 10
        self.playlist = ["music/Botanic Panic.wav", "music/Carnival Kerfuffle.wav",
                         "music/Cuphead OST - Floral Fury [Music].wav", "music/Cuphead OST - Hurry Up [Music].wav",
                         "music/One Hell of a Time.wav"]
    ...
    def __draw_game(self, start):
        ...
        add_image(self.screen, "images/start.png", START_NEW_ROUND_X, START_NEW_ROUND_Y, START_NEW_ROUND_WIDTH,
                  START_NEW_ROUND_HEIGHT, (0, 0, 0))
        add_image(self.screen, "images/cuphead.jpg", x_ball, BALL_Y, BALL_WIDTH, BALL_HEIGHT, None)
        add_image(self.screen, "images/cup.jpg", self.posList[0], self.current_y_cup, CUP_WIDTH,
                  CUP_HEIGHT, (0, 0, 0))
        add_image(self.screen, "images/cup.jpg", self.posList[1], self.current_y_cup, CUP_WIDTH,
                  CUP_HEIGHT, (0, 0, 0))
